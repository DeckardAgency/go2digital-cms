...
@Component({
  ...
  template: `
    <app-block-typography-card
      blockId="esg"
      [elementKeys]="['pillarNumber', 'pillarTitle', 'pillarDesc']"
      title="Pillar Typography"
      subtitle="Applied to each pillar on the public /esg page. Saving updates the shared ESG block map." />
