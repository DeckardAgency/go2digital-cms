    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <p-button icon="pi pi-arrow-left" severity="secondary" [text]="true" [rounded]="true" (onClick)="router.navigate(['/homepage/panels'])" />
          <div>
            <h1 class="text-2xl font-semibold text-surface-900 dark:text-surface-0">{{ isEditMode() ? 'Edit Panel' : 'New Panel' }}</h1>
            <p class="text-surface-500 dark:text-surface-400 text-sm mt-0.5">Horizontal scroll panel with stat value</p>
          </div>
        </div>
          ...
          <div class="bg-surface-0 dark:bg-surface-900 rounded-xl border border-surface-200 dark:border-surface-700 p-6">
            ...
            <div class="flex flex-col gap-4">
              <div class="flex flex-col gap-2">
                ...
                <input pInputText class="w-full" [(ngModel)]="statValue" placeholder="e.g. 2.5M" />
              </div>
              <div class="flex flex-col gap-2">
          ...
          <div class="bg-surface-0 dark:bg-surface-900 rounded-xl border border-surface-200 dark:border-surface-700 p-6">
            ...
            <div class="flex flex-col gap-3 text-sm">
              <div class="flex justify-between">
                ...
                <span class="font-medium text-surface-900 dark:text-surface-0">#2 Horizontal Scroll</span>
              </div>
              <div class="flex justify-between">
