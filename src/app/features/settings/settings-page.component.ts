  ...
  template: `
    <div>
      <div class="flex items-center justify-between mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-surface-900 dark:text-surface-0">Settings</h1>
          <p class="text-surface-500 text-sm mt-0.5">Manage site configuration, integrations, and maintenance</p>
        </div>
      </div>

      <p-tabs [value]="0">
        <p-tablist>
          <p-tab [value]="0"><i class="pi pi-cog mr-2"></i><span class="text-sm">General</span></p-tab>
          <p-tab [value]="1"><i class="pi pi-link mr-2"></i><span class="text-sm">Integrations</span></p-tab>
          <p-tab [value]="2"><i class="pi pi-search mr-2"></i><span class="text-sm">SEO</span></p-tab>
          <p-tab [value]="3"><i class="pi pi-language mr-2"></i><span class="text-sm">Translations</span></p-tab>
          <p-tab [value]="4"><i class="pi pi-wrench mr-2"></i><span class="text-sm">Maintenance</span></p-tab>
          <p-tab [value]="5"><i class="pi pi-database mr-2"></i><span class="text-sm">All Settings</span></p-tab>
        </p-tablist>
        ...
        <p-tabpanels>
          ...
          <!-- ═══ GENERAL ═══ -->
          <p-tabpanel [value]="0">
            <div class="max-w-2xl pt-4 space-y-6">
              <div class="bg-surface-0 dark:bg-surface-900 rounded-xl border border-surface-200 dark:border-surface-700 p-6">
                ...
                <div class="flex justify-end mt-6">
                  <p-button label="Save General" icon="pi pi-save" [loading]="saving()" (onClick)="saveGroup('general')" />
                </div>
              </div>
            </div>
          </p-tabpanel>
          ...
          <!-- ═══ TRANSLATIONS ═══ -->
          <p-tabpanel [value]="3">
            <div class="max-w-3xl pt-4 space-y-6">
...
export class SettingsPageComponent implements OnInit {
  ...
  private isTranslationSetting(s: Setting): boolean {
    // Translation settings have hr/en keys in value
